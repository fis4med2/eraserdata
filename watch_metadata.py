...
To have this always run in the background on Linux startup, see the
instructions at the bottom of this file (systemd user service / autostart).
"""
...
# Use None for the user's home directory, or set explicit paths.
WATCHED_FOLDERS = [
...
"""
=======================================================================
HOW TO KEEP THIS ALWAYS RUNNING IN THE BACKGROUND (no terminal window):
=======================================================================

Linux (systemd user service):

1. Create a service file at ~/.config/systemd/user/metadata-protector.service:

    [Unit]
    Description=Metadata Protector – Auto-clean image metadata
    After=network.target

    [Service]
    Type=simple
    ExecStart=/home/youruser/metadata-protector/src/watch_metadata.py
    Restart=always
...
2. Enable it:
    ...
    systemctl --user enable metadata-protector
    systemctl --user start metadata-protector

Linux (desktop autostart):

1. Create a file at ~/.local/share/applications/metadata-protector.desktop:

    [Desktop Entry]
    Name=Metadata Protector
    Exec=python /home/youruser/metadata-protector/src/watch_metadata.py
    Type=Application
    Hidden=true

2. Log out and log back in.

## Windows startup (no visible window):

Use pythonw.exe instead of python.exe:

    pythonw.exe C:/path/to/watch_metadata.py

Place a shortcut or VBScript in the Startup folder to run it automatically.
=======================================================================
"""
